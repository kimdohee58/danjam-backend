...
//        return new ResponseEntity<>(user, HttpStatus.OK);
    ...
    public ResponseEntity<?> changePhone(@PathVariable Long id, @RequestBody Map<String, Integer> requestMap) {
        /*Users findByUser = usersService.findById(id);
        if (findByUser == null) {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
...
*/
        return ResponseEntity.ok(usersService.changePhone(id, requestMap.get("phoneNum")));
    }

    @Transactional
    @PatchMapping("{id}/cancel")
    public ResponseEntity<?> cancelMember(@PathVariable Long id) {
        /*Users findByUser = usersService.findById(id);
        if (findByUser == null) {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
        ...
        return new ResponseEntity<>(HttpStatus.OK);*/
        return ResponseEntity.ok((usersService.cancel(id)));
    }

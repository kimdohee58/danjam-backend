...
public class RoomController {
    ...
    public ResponseEntity<HashMap<String, Object>> insert(@RequestBody RoomAddDTO roomAddDTO) {
    ...
    @GetMapping("/room/{id}")
    public ResponseEntity<HashMap<String, Object>> getRoomIdsByDormId(@PathVariable("id") Long dormId) {
        ...
        return ResponseEntity.ok(roomController);
    }

    @GetMapping("/rooms/{id}")
    public ResponseEntity<HashMap<String, Object>> getRoomByDormId(@PathVariable("id") Long dormId) {

...
//    @GetMapping("/showAll")
//    public ResponseEntity<Map<?, ?>> findAllList() {
//        Map<String, Object> resultMap = new HashMap();
//
...
//    }
    ...
    @GetMapping("/showAll")
    public ResponseEntity<Map<?, ?>> findAllList(Pageable pageable) {
...
//        List<Tuple> list = searchService.findAllList();
    ...
    @PostMapping("/search")
    public ResponseEntity<Map<?, ?>> findList(@RequestBody SearchDto searchDto) {
    ...
    public ResponseEntity<Map<?, ?>> findByFilter(@RequestBody FilterDto filterDto) {
